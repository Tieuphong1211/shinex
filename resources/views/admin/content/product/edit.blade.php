<div data-twe-modal-init
    ...
    id="editModal" tabindex="-1" aria-labelledby="exampleModalVaryingLabel" aria-hidden="true">
                ...
                <form id="edit-product-form" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="flex gap-2">
                            ...
                            id="edit-thumbnail" name="file-path" readonly/>
                            <button id="lfm-2" data-input="edit-thumbnail" data-preview="edit-holder" class="add-image-file">
                                <i class="fa-solid fa-upload"></i>
                            </button>
                        </div>
                        <div class="mt-3" id="edit-holder"></div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea
                            ...
                            id="edit-description" name="edit-description"></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea
                            class="relative m-0 -me-0.5 block w-full flex-auto rounded border border-solid border-neutral-300 bg-transparent bg-clip-padding px-3 py-[0.25rem] text-base font-normal leading-[1.6] text-neutral-700 outline-none transition duration-200 ease-in-out focus:z-[3] focus:border-primary focus:text-neutral-700 focus:shadow-inset focus:outline-none dark:border-neutral-500 dark:bg-body-dark dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:focus:border-primary"
                            id="edit-content" name="edit-content"></textarea>
                    </div>
                </form>
            </div>
            <div
...
<script>
    ...
    $('#lfm-2').filemanager('image', {prefix: route_prefix});
