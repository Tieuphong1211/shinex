<div class="bg-[#313035] sm:px-16">
    <div class="flex justify-center">
        <div class="grid lg:grid-cols-3 gap-5 xl:gap-20 xl:justify-center 2xl:w-[65%] ">
            <div class="px-3 text-base text-[#999999] pt-12">
                <a href="#"><img class="w-[25%] lg:w-[50%]" src="{{asset('ImgProduct/logo.png')}}" alt=""></a>
                <p class="py-4">AidanTechnologies is a world-class digital agency based in Malaysia, that focuses on creating innovative digital solutions.</p>
                <i class="fa-solid fa-phone pb-3"></i><span class="px-3">+ 603 - 4143 0572</span><br>
                <i class="fa-solid fa-envelope"></i> <span class="px-3">sales@aidan.my</span>
            </div>

            <div class="mt-2 lg:pt-8">
                <h1 class="pl-3 text-xl border-b-[1px] border-white text-white">Useful Links</h1>
                <ul class="cursor-pointer text-base xl:text-sm">
            ...
            <div class="mt-2 lg:pt-8">
                ...
                <ul class="cursor-pointer text-base text-[#999999]">
    ...
    <p class="py-10 text-center">© 2023 All rights reserved.<span class="text-[#f53a03] ">Aidan Technologies Sdn Bhd</span></p>
</div>
